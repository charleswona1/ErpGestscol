              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
				...
				<table style="text-align:center; width: 100%;">
					...
					<tr>
						...
						<a class="dropdown-item " href="gestscol-tb.html">
						  <div >
					...
					<tr>
						...
						<td>
						<a class="dropdown-item " href="utilisateurs-tb.html">
						  <div >
...
<!-- ======= Header ======= -->
  <header id="header" style="margin-bottom:10px; margin-top:10px;" >
    ...
    <nav class="nav-menu ml-0 col-md-11" style="text-align:left; ">
		<ul >
		  <li  style="font-size: 1.2em; position:relative; margin-left:10px; margin-top:5px; color: black;"> <i class="fas fa-user-cog"></i> Administration &nbsp;| &nbsp;&nbsp; </li>
		  <li><a href="{{route("user.tb")}}">Tableau de bord</a></li>
		  <li class="active"><a href="utilisateurs-usr.html">Utilisateurs</a></li>
		  <li><a href="utilisateur-gr.html">Groupes d'utilisateurs</a></li>
   ...
   <header id="header2" scrolling="no" frameborder="0" allowTransparency="true"  overflow:"hidden" >
	...
	<nav style="margin: 15px auto; height:20px;"  class="navbar navbar-expand navbar-light  topbar col-md-8 ">
            ...
            <form  style="position: relative; top:10px;" class="d-none d-sm-inline-block form-inline mr-auto ml-md-2 my-2 my-md-0 mw-100 navbar-search">
				<div class="input-group">
              <input type="text" class="form-control bg-white border-0  small" style="border-radius:5px; height:30px; position:relative; top:15px;" placeholder="Recherche utilisateur..." aria-label="Search" aria-describedby="basic-addon2">
	...
	<ul class="navbar-nav bg-gradient-light sidebar sidebar-dark accordion" id="accordionSidebar"  style="z-index:3;">
				...
				<li class="nav-item">
					...
					<div id="collapseListes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					  <div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="#">Tous les utilisateurs</a>
			...
			<style>
				#submenu1,#submenu2,#submenu3,#submenu4,#submenu5,#submenu6,#submenu7,#submenu8,#submenu9,#submenu10,#submenu11,#submenu12,#submenu13,#submenu14
				{
				  ...
				  <li class="nav-item">
					<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFavorites" aria-expanded="true" aria-controls="collapseUtilities">
					  <i class="fas fa-star "></i>
					  <span>Favories</span>
					</a>
					<div id="collapseFavorites" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					  <div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" data-toggle="collapse" data-target="#collapseFavorites" style="color:#aeaeae; href="#">
							
								No favorites found</a>
		...
		<div class="row" >
					...
					<!-- <div class="nav-item dropdown no-arrow mx-1"> -->
						...
						<div class="invoice col-md-3" style="text-align:right;">
							<button class="button-search rounded-circle1" data-toggle="modal" data-target=".bd-example-modal-lg" style="font-size:0.7em; width:150px;  z-index:4">
							<span><i class="fa fa-plus" aria-hidden="true"></i>&nbsp Créer Utilisateur</span></button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Compte Utilisateur</h5>
...
<article class="card-body mx-auto" style="max-width: 400px;">
  <h4 class="card-title mx-auto text-center" style="color: grey;">Création d'un nouvel utilisateur</h4>
 <!-- <p class="text-center">Get started with your free account</p>
  ...
  <div class="form-group input-group ">
    <div class="input-group-prepend">
        ...
        <input name="" class="form-control" placeholder="Nom de l'utilisateur" type="text">
    ...
    <div class="form-group input-group">
      <div class="input-group-prepend">
        ...
        <input name="" class="form-control" placeholder="Login" type="login">
    </div>
    <!-- form-group// -->
    <div class="form-group input-group">
      <div class="input-group-prepend">
   ...
   <!-- <select class="custom-select" style="max-width: 120px;">
    ...
    <select class="form-control">
      <option selected=""> Groupe d'utilisateur</option>
    ...
    <div class="form-group input-group">
      <div class="input-group-prepend">
        ...
        <input class="form-control" placeholder="Mots de passe" type="password">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
      <div class="input-group-prepend">
        <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
    </div>
        <input class="form-control" placeholder="Confirmer le mots de passe" type="password">
    </div> <!-- form-group// -->                                      
