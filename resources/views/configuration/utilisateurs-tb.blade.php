...
<!-- ======= Header ======= -->
  <header id="header" style="margin-bottom:10px; margin-top:10px;" >
    ...
    <nav class="nav-menu ml-0 col-md-11" style="text-align:left; ">
		<ul >
		  <li  style="font-size: 1.2em; position:relative; margin-left:10px; margin-top:5px; color: black;"> <i class="fa fa-dashboard"></i> Administration &nbsp;| &nbsp;&nbsp; </li>
		  <li><a href="{{route("user.tb")}}">Tableau de bord</a></li>
		  <li><a href="utilisateurs-usr.html">Utilisateurs</a></li>
