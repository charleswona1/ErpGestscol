<aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
    ...
    <div class="mdc-drawer__content">
     <!-- <div class="user-info" style="text-align:center">
        ...
        <p class="email">Collège Vogt</p>
      </div>  -->
      <div class="mdc-list-group">
        <nav class="mdc-list mdc-drawer-menu">
          <div class="mdc-list-item mdc-drawer-item">
            <a class="mdc-drawer-link" href="/configuration/dashboard">
          ...
          <div class="mdc-list-item mdc-drawer-item">
            ...
            <div class="mdc-expansion-panel" id="sample-page-submenu">
              <nav class="mdc-list mdc-drawer-submenu">
                ...
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="/configuration/matricule">
                    Matricule
                  </a>
                </div>
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="/configuration/periode">
                    Périodes
                  </a>
                </div>
              </nav>
           ...
           <div class="mdc-list-item mdc-drawer-item">
            ...
            <div class="mdc-expansion-panel" id="ui-sub-menu">
              <nav class="mdc-list mdc-drawer-submenu">
              <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="/configuration/utilisateur/profilU">
                    Profiles
                  </a>
                </div>
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="/configuration/utilisateur/groupe">
                    Groupes
                  </a>
                </div>
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="/configuration/utilisateur/parametrage">
                    Paramétrages
                  </a>
                </div>
              </nav>
          ...
          <div class="mdc-list-item mdc-drawer-item">
            ...
            <div class="mdc-expansion-panel" id="ui1-sub-menu">
              ...
              <div class="mdc-list-item mdc-drawer-item">
                ...
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="/configuration/documentation/entete">
                    Entêtes
                  </a>
                </div>
                <div class="mdc-list-item mdc-drawer-item">
                  <a class="mdc-drawer-link" href="/configuration/documentation/signature">
                    Signatures
                  </a>
                </div>
              </nav>
