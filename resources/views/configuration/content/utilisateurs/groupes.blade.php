                        ...
                        <form class='cntt-wrapper'>
                            ...
                            <div class="mdc-layout-grid">
                                <div class="mdc-layout-grid__inner">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-8">
                                        <a href="utilisateur-groupe.html" class="mdc-button mdc-button--success w-100">
                                            Enregistrer
                                        </a>
                                    </div>
                                ...
                                <table class="mdc-data-table__table" aria-label="Dessert calories">
                                    <thead>
                                        <tr class="mdc-data-table__header-row">
                                            ...
                                            <th class="mdc-data-table__header-cell" role="columnheader" scope="col">Date de
                                                création</th>
                                            <th class="mdc-data-table__header-cell" role="columnheader" scope="col">Statut
                                            </th>
                                    ...
                                    <tbody class="mdc-data-table__content">
                                        <tr data-row-id="u0" class="mdc-data-table__row">
                                            ...
                                            <td class="mdc-data-table__cell">Administration complète de l'Etablissement</td>
                                            ...
                                            <td class="mdc-data-table__cell">
                                                <a href="utilisateur-groupe-profil.html"><i
                                                        class="material-icons mdc-text-field__icon"
                                                        style="color:black; font-size:1.5em;">visibility</i></a>
                                                <a href="/configuration/utilisateur/editGroupe"><i
                                                        class="material-icons mdc-text-field__icon"
                                        ...
                                        <tr data-row-id="u0" class="mdc-data-table__row">
                                            ...
                                            <td class="mdc-data-table__cell" scope="row" id="u0">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-left flex2">
                                                            <div class="widget-heading font-weight-bolder">Principal
                                                                &nbsp;<i class="fa fa-envelope-o text-link"
                                                                    style="cursor:pointer;" aria-hidden="true"></i>
                                                                <!-- &nbsp;<i class="fa fa-phone" style="cursor:pointer;" aria-hidden="true"></i> -->
                                                                &nbsp;<i class="fa fa-whatsapp text-link"
                                            ...
                                            <td class="mdc-data-table__cell">Responsable de l'établissement</td>
