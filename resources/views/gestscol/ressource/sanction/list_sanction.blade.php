                        ...
                        <table class="mb-0 table table-hover" >
                            ...
                            <tr>
                                ...
                                <td class="mdc-data-table__cell">
                                    ...
                                    <a href="{{route('gestscol.formulaire_sanction.update',  $sanction->id_sanction)}}"><i class="fas fa-edit"></i></i></a>
                                    <a href=""><i class="fas fa-print"></i></i></a>
                                    <a href="{{route('gestscol.sanction.delete',  $sanction->id_sanction)}}" style="color:red;"><i class="fas fa-trash"></i></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
