            ...
            <div class="col-md-12">
                 <div class="main-card mb-12 card">
                    ...
                    <div class="card-body col-md-12">
                        <form action="{{ route('gestscol.sanction.parametrage.create') }}" method="POST">
                            @csrf
                        <table class="col-md-12">
                            ...
                            <tr class="col-md-12">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <input name="valeur"  placeholder="Valeur" type="number" class="form-control" required>
                                </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="col-md-6">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Valeur <span style="color:red;">*</span></label><input name="valeur2"  placeholder="Valeur" type="number" class="form-control" required>
                                </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="mdc-data-table__cell">
                                        ...
                                        <a href="tilisateur-profil.html"><i class="fas fa-eye"></i></i></a>
                                        ...
                                        <a href="{{route('gestscol.sanction.parametrage.delete',  $item->id_parametrage)}}" style="color:red;"><i class="fas fa-trash"></i></i></a>
                                    </td>
                                </tr>    
                                @empty
                                <tr>
