    ...
    <div class="row">
        ...
        <div class="col-md-10">
                     <div class="main-card mb-3 card">
                        ...
                        <div class="card-body ">
                            <form action="{{route('gestscol.groupe_matiere.store')}}" method="POST">
                                @csrf 
                                <table class="col-md-12">
                                    ...
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="nom" id="exampleEmail" placeholder=" " type="text" class="form-control" required>
                                    </div>
                                        </td>
                                    ...
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="numero" id="exampleEmail" placeholder=" " type="number" class="form-control" required>
                                    </div>
                                        </td>
