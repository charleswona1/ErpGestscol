                    ...
                    <table class="mdc-data-table__table" aria-label="Dessert calories">
					  ...
					  <tbody class="mdc-data-table__content">
						<tr data-row-id="u0" class="mdc-data-table__row">
						  ...
						  <td class="mdc-data-table__cell">Fabrizio-Kmer</td>
						  ...
						  <td class="mdc-data-table__cell">
							<a href="utilisateur-profil.html"><i class="material-icons mdc-text-field__icon" style="color:black; font-size:1.5em;">visibility</i></a>
						...
						<tr data-row-id="u0" class="mdc-data-table__row">
							...
							<div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                ...
                                                                <div class="widget-subheading text-muted opacity-7">Responsable Informatique</div>
                                                            </div>
                                                        </div>
						  </td>
						  ...
						  <td class="mdc-data-table__cell">Coll&egrave;ge Vogt, Pr&eacute;pavogt</td>
						  <!-- <td class="mdc-data-table__cell mdc-data-table__cell--numeric">Tous</td> -->
						  <td class="mdc-data-table__cell">
							<div class="mdc-switch mdc-switch--success" data-mdc-auto-init="MDCSwitch">
							  <div class="mdc-switch__track"></div>
						...
						<tr data-row-id="u0" class="mdc-data-table__row">
						  ...
						  <td class="mdc-data-table__cell">mbazo237</td>
						  <td class="mdc-data-table__cell">+237 678 15 24 75</td>
						  <td class="mdc-data-table__cell">02-08-2021 18:06</td>
						  <td class="mdc-data-table__cell">Coll&egrave;ge de la Retraite</td>
						  <!-- <td class="mdc-data-table__cell mdc-data-table__cell--numeric">Tous</td> -->
						  <td class="mdc-data-table__cell">
							<div class="mdc-switch mdc-switch--success" data-mdc-auto-init="MDCSwitch">
							  <div class="mdc-switch__track"></div>
