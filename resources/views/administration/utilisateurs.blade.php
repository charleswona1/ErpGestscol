          ...
          @csrf
                      ...
                      <div class="mdc-layout-grid__inner">
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input @error('nom') is-invalid @enderror" id="text-field-hero-input" name="nom" value="{{ old('nom') }}" required autocomplete="nom" autofocus>
                          ...
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input @error('telephone') is-invalid @enderror" id="text-field-hero-input" name="telephone" value="{{ old('telephone') }}" required autocomplete="telephone">
                            <div class="mdc-line-ripple"></div>
						...
						<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input @error('email') is-invalid @enderror" name="email" id="text-field-hero-input" value="{{ old('email') }}" required autocomplete="email">
                            <div class="mdc-line-ripple"></div>
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input @error('password') is-invalid @enderror" type="password" id="text-field-hero-input" name="password" required autocomplete="new-password">
                            <div class="mdc-line-ripple"></div>
						...
						<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input" type="password" name="password_confirmation" id="text-field-hero-input" required autocomplete="new-password">
                            <div class="mdc-line-ripple"></div>
						...
						<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-8">
                          <a  class="mdc-button mdc-button--raised w-100" onclick="event.preventDefault(); document.getElementById('form_admin').submit();">
                            Enregistrer
                          </a>
                        </div>
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
				...
				<div class="d-flex justify-content-between">
                   <center><h6 class="card-title card-padding pb-0" style="color:grey;" >Liste des Utilisateurs</h6></center>
                    ...
                    <table class="mdc-data-table__table" aria-label="Dessert calories">
					  <thead>
						<tr class="mdc-data-table__header-row">
						  ...
						  <th class="mdc-data-table__header-cell" role="columnheader" scope="col">Nom complet | Fonction</th>
						  ...
						  <th class="mdc-data-table__header-cell" role="columnheader" scope="col">Date de cr&eacute;ation</th>
            ...
            @foreach ($listAdmin as $admin)
  							...
  							<div class="widget-content p-0">
                                                          <div class="widget-content-wrapper">
                                                              ...
                                                              <div class="widget-content-left flex2">
                                                                  <div class="widget-heading font-weight-bolder">{{$admin->nom}}
                    ...
                    @endif
  						  ...
  						  <td class="mdc-data-table__cell">
  							<a href="/administrateur/profil/{{$admin->id_admin}}"><i class="material-icons mdc-text-field__icon" style="color:black; font-size:1.5em;">visibility</i></a>
  							<a href="/administrateur/edit_admin/{{$admin->id_admin}}"><i class="material-icons mdc-text-field__icon" style="color:black; font-size:1.5em;">edit</i></a>
                ...
                <a href="#"><i class="material-icons mdc-text-field__icon" style="color:black; font-size:1.5em;">print</i></a>
  							<a onclick="supprimer_admin({{$admin->id_admin}})"><i class="material-icons mdc-text-field__icon" style="color:red; font-size:1.5em;">delete</i></a>
  						  </td>
  						</tr>
            @endforeach
