                        ...
                        <div class="mdc-layout-grid">
                            <div class="mdc-layout-grid__inner">
                                ...
                                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-4">
                                    <a href="config-admin-groupe.html" id="cancel"
                                        class="mdc-button mdc-button--label w-100">
                                        Annuler
                                    </a>
                                </div>
                                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-8">
                            ...
                            <table class="mdc-data-table__table" aria-label="Dessert calories">
                                <thead>
                                    <tr class="mdc-data-table__header-row">
                                        ...
                                        <th class="mdc-data-table__header-cell" role="columnheader" scope="col">Groupe
                                            Parent</th>
                                        <th class="mdc-data-table__header-cell" role="columnheader" scope="col">Description
                                        </th>
                                ...
                                <tbody class="mdc-data-table__content">
                                    <tr data-row-id="u0" class="mdc-data-table__row">
                                                    ...
                                                    <div class="widget-content-left flex2">
                                                        <div class="widget-heading font-weight-bolder">Super Administrateur
                                                            ...
                                                            &nbsp;<i class="fa fa-whatsapp text-link"
                                                                style="cursor:pointer;" aria-hidden="true"></i>
                                                            &nbsp;<i class="fa fa-skype text-link" style="cursor:pointer;"
                                                                aria-hidden="true"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <td class="mdc-data-table__cell">
                                            <a href="config-admin-profil.html"><i
                                                    class="material-icons mdc-text-field__icon"
                                                    style="color:black; font-size:1.5em;">visibility</i></a>
                                            <a href="config-admin-profiledit.html"><i
                                                    class="material-icons mdc-text-field__icon"
                                    ...
                                    <tr data-row-id="u0" class="mdc-data-table__row">
                                        ...
                                        <td class="mdc-data-table__cell">
                                            <a href="licence-profil.html"><i class="material-icons mdc-text-field__icon"
                                                    style="color:black; font-size:1.5em;">visibility</i></a>
                                            <a href="licence-profiledit.html"><i class="material-icons mdc-text-field__icon"
                                                    style="color:black; font-size:1.5em;">edit</i></a>
                                            <a href=""><i class="material-icons mdc-text-field__icon"
                                                    style="color:black; font-size:1.5em;">print</i></a>
                                            <a href=""><i class="material-icons mdc-text-field__icon"
