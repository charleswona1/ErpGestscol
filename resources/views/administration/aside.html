    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      <div class="mdc-drawer__header">
        <a href="index.html" class="brand-logo">
			<center>
          <img src="../assets/images/admin.png" height="40px"alt="logo"> 
       ...
       <!-- <div class="user-info" style="text-align:center">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="etablissements.html">
			...
			<div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="utilisateurs.html">
                <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">person</i>
                Utilisateurs
              </a>
            </div>
			<div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="licences.html">
			...
			<div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-expansion-panel" id="ui-sub-menu">
                <nav class="mdc-list mdc-drawer-submenu">
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="Config-admin-groupe.html">
                      Groupes
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="Config-admin-parametrages.html">
                      Paramétrages
                    </a>
                  </div>
                </nav>
